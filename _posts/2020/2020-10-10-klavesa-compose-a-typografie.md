...
category: nondev
tags: [ Compose, typografie, pokročilejší seznámení, tipy, Windows, Ubuntu (linux), MacOS ]
show_toc: 3
reference:
    - lokální:
        wiki:
